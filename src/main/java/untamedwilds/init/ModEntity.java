...
public class ModEntity {
    ...
    public static void bakeAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(MAMMOTH.get(), EntityMammoth.registerAttributes().build());
        event.put(DEER.get(), EntityDeer.registerAttributes().build());
        ...
        event.put(GLYPTODONT.get(), EntityGlyptodont.registerAttributes().build());
    ...
    public static void onRegisterRenderer(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntity.MAMMOTH.get(), RendererMammoth::new);
        event.registerEntityRenderer(ModEntity.DEER.get(), RendererDeer::new);
        ...
        event.registerEntityRenderer(ModEntity.GLYPTODONT.get(), RendererGlyptodont::new);
