...
public class ModelEquid extends AdvancedEntityModel<EntityEquid> {
    ...
    public void setupAnim(EntityEquid equid, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (equid.sitProgress > 0) {
            this.progressPosition(body_main, equid.sitProgress, 0.0F, 17.5F, 0.0F, 40);
            this.progressRotation(head_neck, equid.sitProgress, (float) Math.toRadians(-33.91F), 0, 0, 40);
            this.progressRotation(head_main, equid.sitProgress, (float) Math.toRadians(-2.61F), 0, 0, 40);
            this.progressPosition(arm_right_1, equid.sitProgress, -4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_right_1, equid.sitProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_right_2, equid.sitProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(-15.65F), 40);
            this.progressPosition(arm_left_1, equid.sitProgress, 4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_left_1, equid.sitProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_left_2, equid.sitProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(15.65F), 40);
            this.progressRotation(leg_right_thigh, equid.sitProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(15.65F), 0, 40);
            this.progressRotation(leg_right_calf, equid.sitProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(-10.43F), 40);
            this.progressRotation(leg_left_thigh, equid.sitProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(-15.65F), 0, 40);
            this.progressRotation(leg_left_calf, equid.sitProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(10.43F), 40);
        }

        // Sleeping Animation
        else if (equid.sleepProgress > 0) {
            this.progressPosition(body_main, equid.sleepProgress, 0.0F, 17.5F, 0.0F, 40);
            this.progressPosition(arm_right_1, equid.sleepProgress, -4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_right_1, equid.sleepProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_right_2, equid.sleepProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(-15.65F), 40);
            this.progressPosition(arm_left_1, equid.sleepProgress, 4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_left_1, equid.sleepProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_left_2, equid.sleepProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(15.65F), 40);
            this.progressRotation(leg_right_thigh, equid.sleepProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(15.65F), 0, 40);
            this.progressRotation(leg_right_calf, equid.sleepProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(-10.43F), 40);
            this.progressRotation(leg_left_thigh, equid.sleepProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(-15.65F), 0, 40);
            this.progressRotation(leg_left_calf, equid.sleepProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(10.43F), 40);
        }
    }
}
