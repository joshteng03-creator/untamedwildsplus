...
public class ModelDeer extends AdvancedEntityModel<EntityDeer> {
    ...
    private final AdvancedModelBox antler_left;
    private final AdvancedModelBox antler_left_tine;
    private final AdvancedModelBox antler_right;
    private final AdvancedModelBox antler_right_tine;
    ...
    public ModelDeer() {
        ...
        // Antlers: a beam and a forward tine on each side of the head
        this.antler_left = new AdvancedModelBox(this, 100, 0);
        this.antler_left.setRotationPoint(2.0F, -3.5F, -2.0F);
        this.antler_left.addBox(-0.5F, -7.0F, -0.5F, 1, 7, 1, 0.0F);
        this.setRotateAngle(antler_left, -0.2276F, 0.0F, -0.4553F);
        this.antler_left_tine = new AdvancedModelBox(this, 104, 0);
        this.antler_left_tine.setRotationPoint(0.0F, -5.0F, 0.0F);
        this.antler_left_tine.addBox(-0.5F, -4.0F, -0.5F, 1, 4, 1, 0.0F);
        this.setRotateAngle(antler_left_tine, -0.6373F, 0.0F, 0.4553F);
        this.antler_right = new AdvancedModelBox(this, 100, 0);
        this.antler_right.mirror = true;
        this.antler_right.setRotationPoint(-2.0F, -3.5F, -2.0F);
        this.antler_right.addBox(-0.5F, -7.0F, -0.5F, 1, 7, 1, 0.0F);
        this.setRotateAngle(antler_right, -0.2276F, 0.0F, 0.4553F);
        this.antler_right_tine = new AdvancedModelBox(this, 104, 0);
        this.antler_right_tine.mirror = true;
        this.antler_right_tine.setRotationPoint(0.0F, -5.0F, 0.0F);
        this.antler_right_tine.addBox(-0.5F, -4.0F, -0.5F, 1, 4, 1, 0.0F);
        this.setRotateAngle(antler_right_tine, -0.6373F, 0.0F, -0.4553F);
        this.head_main.addChild(this.antler_left);
        this.antler_left.addChild(this.antler_left_tine);
        this.head_main.addChild(this.antler_right);
        this.antler_right.addChild(this.antler_right_tine);
    ...
    public void setupAnim(EntityDeer deer, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (deer.sitProgress > 0) {
            this.progressPosition(body_main, deer.sitProgress, 0.0F, 17.5F, 0.0F, 40);
            this.progressRotation(head_neck, deer.sitProgress, (float) Math.toRadians(-33.91F), 0, 0, 40);
            this.progressRotation(head_main, deer.sitProgress, (float) Math.toRadians(-2.61F), 0, 0, 40);
            this.progressPosition(arm_right_1, deer.sitProgress, -4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_right_1, deer.sitProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_right_2, deer.sitProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(-15.65F), 40);
            this.progressPosition(arm_left_1, deer.sitProgress, 4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_left_1, deer.sitProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_left_2, deer.sitProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(15.65F), 40);
            this.progressRotation(leg_right_thigh, deer.sitProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(15.65F), 0, 40);
            this.progressRotation(leg_right_calf, deer.sitProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(-10.43F), 40);
            this.progressRotation(leg_left_thigh, deer.sitProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(-15.65F), 0, 40);
            this.progressRotation(leg_left_calf, deer.sitProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(10.43F), 40);
        }

        // Sleeping Animation
        else if (deer.sleepProgress > 0) {
            this.progressPosition(body_main, deer.sleepProgress, 0.0F, 17.5F, 0.0F, 40);
            this.progressPosition(arm_right_1, deer.sleepProgress, -4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_right_1, deer.sleepProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_right_2, deer.sleepProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(-15.65F), 40);
            this.progressPosition(arm_left_1, deer.sleepProgress, 4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_left_1, deer.sleepProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_left_2, deer.sleepProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(15.65F), 40);
            this.progressRotation(leg_right_thigh, deer.sleepProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(15.65F), 0, 40);
            this.progressRotation(leg_right_calf, deer.sleepProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(-10.43F), 40);
            this.progressRotation(leg_left_thigh, deer.sleepProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(-15.65F), 0, 40);
            this.progressRotation(leg_left_calf, deer.sleepProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(10.43F), 40);
        }
    }
}
