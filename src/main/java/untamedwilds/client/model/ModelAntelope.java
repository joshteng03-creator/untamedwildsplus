...
public class ModelAntelope extends AdvancedEntityModel<EntityAntelope> {
    ...
    public ModelAntelope() {
        ...
        // Upright horns, plus a bulbous nose cube shown only on saiga-type variants
        this.horn_left = new AdvancedModelBox(this, 100, 0);
        this.horn_left.setRotationPoint(1.5F, -3.5F, -2.0F);
        this.horn_left.addBox(-0.5F, -5.0F, -0.5F, 1, 5, 1, 0.0F);
        this.setRotateAngle(horn_left, -0.1366F, 0.0F, -0.2276F);
        this.horn_right = new AdvancedModelBox(this, 100, 0);
        this.horn_right.mirror = true;
        this.horn_right.setRotationPoint(-1.5F, -3.5F, -2.0F);
        this.horn_right.addBox(-0.5F, -5.0F, -0.5F, 1, 5, 1, 0.0F);
        this.setRotateAngle(horn_right, -0.1366F, 0.0F, 0.2276F);
        this.nose_bulb = new AdvancedModelBox(this, 104, 0);
        this.nose_bulb.setRotationPoint(0.0F, 1.0F, -5.0F);
        this.nose_bulb.addBox(-1.5F, -1.5F, -2.0F, 3, 3, 2, 0.0F);
        this.head_main.addChild(this.horn_left);
        this.head_main.addChild(this.horn_right);
        this.head_main.addChild(this.nose_bulb);
    ...
    public void setupAnim(EntityAntelope antelope, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        // Saiga-type variants get the bulbous nose; others hide it.
        ...
        if (antelope.sitProgress > 0) {
            this.progressPosition(body_main, antelope.sitProgress, 0.0F, 17.5F, 0.0F, 40);
            this.progressRotation(head_neck, antelope.sitProgress, (float) Math.toRadians(-33.91F), 0, 0, 40);
            this.progressRotation(head_main, antelope.sitProgress, (float) Math.toRadians(-2.61F), 0, 0, 40);
            this.progressPosition(arm_right_1, antelope.sitProgress, -4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_right_1, antelope.sitProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_right_2, antelope.sitProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(-15.65F), 40);
            this.progressPosition(arm_left_1, antelope.sitProgress, 4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_left_1, antelope.sitProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_left_2, antelope.sitProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(15.65F), 40);
            this.progressRotation(leg_right_thigh, antelope.sitProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(15.65F), 0, 40);
            this.progressRotation(leg_right_calf, antelope.sitProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(-10.43F), 40);
            this.progressRotation(leg_left_thigh, antelope.sitProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(-15.65F), 0, 40);
            this.progressRotation(leg_left_calf, antelope.sitProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(10.43F), 40);
        }

        // Sleeping Animation
        else if (antelope.sleepProgress > 0) {
            this.progressPosition(body_main, antelope.sleepProgress, 0.0F, 17.5F, 0.0F, 40);
            this.progressPosition(arm_right_1, antelope.sleepProgress, -4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_right_1, antelope.sleepProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_right_2, antelope.sleepProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(-15.65F), 40);
            this.progressPosition(arm_left_1, antelope.sleepProgress, 4.5F, 0.2F, -2.0F, 40);
            this.progressRotation(arm_left_1, antelope.sleepProgress, (float) Math.toRadians(-65.22F), 0, 0, 40);
            this.progressRotation(arm_left_2, antelope.sleepProgress, (float) Math.toRadians(135.65F), 0.0F, (float) Math.toRadians(15.65F), 40);
            this.progressRotation(leg_right_thigh, antelope.sleepProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(15.65F), 0, 40);
            this.progressRotation(leg_right_calf, antelope.sleepProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(-10.43F), 40);
            this.progressRotation(leg_left_thigh, antelope.sleepProgress, (float) Math.toRadians(-73.04F), (float) Math.toRadians(-15.65F), 0, 40);
            this.progressRotation(leg_left_calf, antelope.sleepProgress, (float) Math.toRadians(-10.43F), 0.0F, (float) Math.toRadians(10.43F), 40);
        }
    }
}
