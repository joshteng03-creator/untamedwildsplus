...
public class EntityGiraffid extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity, INeedsPostUpdate {

    public static Animation ATTACK_THREATEN;
    public static Animation ATTACK_GORE;

    public EntityGiraffid(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityGiraffid) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityGiraffid getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityGiraffid(ModEntity.GIRAFFID.get(), this.level));
    }
