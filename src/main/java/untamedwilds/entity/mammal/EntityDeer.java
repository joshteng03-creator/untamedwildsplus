...
public class EntityDeer extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity, INeedsPostUpdate {

    public static Animation ATTACK_THREATEN;
    public static Animation ATTACK_GORE;

    public EntityDeer(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityDeer) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityDeer getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityDeer(ModEntity.DEER.get(), this.level));
    }
