...
public class EntityGroundSloth extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity {
    ...
    public EntityGroundSloth(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityGroundSloth) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityGroundSloth getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityGroundSloth(ModEntity.GROUND_SLOTH.get(), this.level));
    }
