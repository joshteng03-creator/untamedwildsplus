...
public class EntityAntelope extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity {
    ...
    public EntityAntelope(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(BULBOUS_NOSE, false);
    }

    public boolean hasBulbousNose(){ return (this.entityData.get(BULBOUS_NOSE)); }
    private void setBulbousNose(boolean bulbous){ this.entityData.set(BULBOUS_NOSE, bulbous); }

    public void addAdditionalSaveData(CompoundTag compound){
        super.addAdditionalSaveData(compound);
        compound.putBoolean("hasBulbousNose", this.hasBulbousNose());
    }

    public void readAdditionalSaveData(CompoundTag compound){
        super.readAdditionalSaveData(compound);
        this.setBulbousNose(compound.getBoolean("hasBulbousNose"));
    }
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityAntelope) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityAntelope getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityAntelope(ModEntity.ANTELOPE.get(), this.level));
    }
    ...
    public void updateAttributes() {
        ...
        this.setBulbousNose(getEntityData(this.getType()).getFlags(this.getVariant(), "hasBulbousNose") == 1);
    }
}
