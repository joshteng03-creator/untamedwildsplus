...
public class EntityMacrauchenia extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity {
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityMacrauchenia) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityMacrauchenia getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityMacrauchenia(ModEntity.MACRAUCHENIA.get(), this.level));
    }
