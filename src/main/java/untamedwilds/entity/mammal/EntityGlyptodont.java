...
public class EntityGlyptodont extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity {
    ...
    public EntityGlyptodont(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(TAIL_CLUB, false);
    }

    public boolean hasTailClub(){ return (this.entityData.get(TAIL_CLUB)); }
    private void setTailClub(boolean club){ this.entityData.set(TAIL_CLUB, club); }

    public void addAdditionalSaveData(CompoundTag compound){
        super.addAdditionalSaveData(compound);
        compound.putBoolean("hasTailClub", this.hasTailClub());
    }

    public void readAdditionalSaveData(CompoundTag compound){
        super.readAdditionalSaveData(compound);
        this.setTailClub(compound.getBoolean("hasTailClub"));
    }
    ...
    @Nullable
    public EntityGlyptodont getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityGlyptodont(ModEntity.GLYPTODONT.get(), this.level));
    }
    ...
    public void updateAttributes() {
        ...
        this.setTailClub(getEntityData(this.getType()).getFlags(this.getVariant(), "hasTailClub") == 1);
    }
}
