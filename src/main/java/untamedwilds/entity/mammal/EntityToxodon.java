...
public class EntityToxodon extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity, INeedsPostUpdate {

    public static Animation ATTACK_THREATEN;
    public static Animation ATTACK_GORE;

    public EntityToxodon(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityToxodon) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityToxodon getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityToxodon(ModEntity.TOXODON.get(), this.level));
    }
