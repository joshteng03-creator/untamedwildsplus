...
public class EntityEquid extends ComplexMobTerrestrial implements INewSkins, ISpecies, IPackEntity, INeedsPostUpdate {

    public static Animation ATTACK_THREATEN;
    public static Animation ATTACK_GORE;

    public EntityEquid(EntityType<? extends ComplexMob> type, Level worldIn) {
        super(type, worldIn);
    ...
    public void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new ProtectChildrenTarget<>(this, LivingEntity.class, true, input -> !(input instanceof EntityEquid) && getEcoLevel(input) > getEcoLevel(this)));
    }
    ...
    @Nullable
    public EntityEquid getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        return create_offspring(new EntityEquid(ModEntity.EQUID.get(), this.level));
    }
